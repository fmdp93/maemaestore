...
@section('admin_content')
    <div class="row px-xl-5 mb-xl-3">
        ...
        <div class="col-xl-5">
            ...
            <form action="{{ route('edit_supplier_submit') }}" method="POST">
                @csrf
                ...
                <input name="company_name" id="company_name" class="form-control form-control-xl mb-xl-3" type="text"
                    aria-label="company_name" value="{{ $company_name }}">
                ...
                <input type="submit" class="float-end btn btn-button-submit text-white py-xl-2 px-xl-5" value="Update Supplier">
            </form>
        </div>
        <div class="col-xl-4">
